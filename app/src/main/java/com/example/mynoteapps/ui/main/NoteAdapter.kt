...
/**
 * Kode dibawah memanggil kelas NoteDiffCallback untuk memeriksa perubahan yang ada pada listNotes.
 * Jadi jika ada perubahan pada listNotes, maka akan memperbarui secara otomatis. NoteDiffCallback
 * digunakan sebagai pengganti notifyDataSetChanged, yang fungsinya sama-sama untuk melakukan
 * pembaharuan item pada RecyclerView
 */
